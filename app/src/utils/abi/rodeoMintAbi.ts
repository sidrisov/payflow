export const rodeoMintAbi = [
  ...
  { inputs: [], name: 'DropMarketLibrary_Mint_Permission_Required', type: 'error' },
  { inputs: [], name: 'DropMarketLibrary_Only_Callable_By_Collection_Admin', type: 'error' },
  {
    inputs: [{ internalType: 'uint256', name: 'maxTime', type: 'uint256' }],
    name: 'DropMarketLibrary_Time_Too_Far_In_The_Future',
    type: 'error'
  },
  { inputs: [], name: 'FETHNode_FETH_Address_Is_Not_A_Contract', type: 'error' },
  { inputs: [], name: 'FETHNode_Only_FETH_Can_Transfer_ETH', type: 'error' },
  {
    inputs: [{ internalType: 'uint256', name: 'expectedValueAmount', type: 'uint256' }],
    name: 'FethNode_Too_Much_Value_Provided',
    type: 'error'
  },
  { inputs: [], name: 'FoundationTreasuryNode_Address_Is_Not_A_Contract', type: 'error' },
  {
    inputs: [],
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'generalAvailabilityStartTime', type: 'uint256' }],
  ...
  { inputs: [], name: 'MultiTokenDropMarketFixedPriceSale_Sale_Terms_Not_Found', type: 'error' },
  {
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'existingSaleTermsId', type: 'uint256' }],
  ...
  { inputs: [], name: 'WorldsNftNode_Worlds_NFT_Is_Not_A_Contract', type: 'error' },
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'uint256', name: 'saleTermsId', type: 'uint256' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'multiTokenContract', type: 'address' },
      { indexed: true, internalType: 'uint256', name: 'tokenId', type: 'uint256' },
      { indexed: true, internalType: 'uint256', name: 'saleTermsId', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'pricePerQuantity', type: 'uint256' },
      {
        indexed: false,
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'uint256', name: 'invalidatedSaleTermsId', type: 'uint256' },
      { indexed: true, internalType: 'uint256', name: 'newSaleTermsId', type: 'uint256' }
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'tokenQuantity', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'pricePerQuantity', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'creatorRevenue', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'worldCuratorRevenue', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'saleTermsId', type: 'uint256' }],
    stateMutability: 'nonpayable',
    type: 'function'
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: 'address payable', name: 'treasuryAddress', type: 'address' }],
    stateMutability: 'view',
    type: 'function'
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'newSaleTermsId', type: 'uint256' }],
    stateMutability: 'nonpayable',
    type: 'function'
  },
