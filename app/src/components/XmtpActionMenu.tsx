...
export function XmtpActionMenu({
  ...
  return (
    <Menu
      ...
      <MenuItem component="a" href={getXmtpAppDmLink('converse', addressOrEns)}>
        <ListItemIcon>
          <Avatar src="xmtp_converse.png" variant="rounded" sx={{ width: 24, height: 24 }} />
        </ListItemIcon>
        converse
      </MenuItem>
      <MenuItem component="a" href={getXmtpAppDmLink('coinbase', addressOrEns)}>
        <ListItemIcon>
          <Avatar src="xmtp_coinbase.png" variant="rounded" sx={{ width: 24, height: 24 }} />
        </ListItemIcon>
        coinbase
      </MenuItem>
      <MenuItem component="a" href={getXmtpAppDmLink('inbox', addressOrEns)}>
        <ListItemIcon>
